...
addCard(
  ...
  "drive.jpg",
  "Drive smoothly",
  "Throttle progressively",
  "Anticipate slows down"
);
addCard(
  "easy",
  "energy",
  "electricity.jpg",
  "Reduce power use",
  "Turn off / unplug electronics you don't use",
  "Use multisockets to easily unplug several electronics"
);
addCard(
  "easy",
  "mobility",
  "travel-local.jpg",
  "Travel Local",
  "Change your far-from-home next holiday by a local travel",
  "If you still want to travel far from home, stay longer and less often"
);
addCard(
  "easy",
  "energy",
  ...
  "Buy energy efficiency electronics",
...
addCard(
  ...
  "food-waste.jpg",
  "Reduce food waste",
  "Try to plan your purchases",
  "Find on the net recipes with the rest of the fridge"
);
addCard(
  "easy",
  "energy",
  "water-usage.jpg",
  "Reduce water usage",
  "Take a shower instead of a bath or take shorter shower",
...
addCard(
  ...
  "drive.jpg",
  "Share your car",
  "Organise car sharing (website, application)",
  "Talk about car sharing to others"
);
...
addCard(
  ...
  "eatlocal.jpg",
  "Eat locally",
  "Find online local producers or order online from your local producers",
  "Gather informations about seasonal products"
);
...
addCard(
  ...
  "travel-local.jpg",
  "Only Travel local",
  "Only travel in your country or a neightboor country",
  "Take the public transport / car sharing to travel local"
);
...
function animateFollowBtn(e) {
  e.currentTarget
    .querySelectorAll(".cta path")
    .forEach((path) => path.classList.add("first-active"));
}
  ...
  followButton.addEventListener("click", (e) => {
    ...
    if (localStorageNotifications) {
      ...
      localStorage.setItem(
        ...
        e.currentTarget.closest(".card-wrapper").dataset.identifier
      );
    } else {
...
function ResizingPagination() {
  ...
  const totalPages =
    document.querySelectorAll(".card." + category).length ||
...
console.info(
  "%cIf you have any question / suggestion regarding this project, feel free to ask me : unam31@gmail.com",
  "color: #1fd12e"
);
